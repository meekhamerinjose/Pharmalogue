...
import pillapp.data.DrugDatabase;
...
public class DbHelper extends SQLiteOpenHelper {
     ...
     * Table names
     */
    private static final String DRUG_DATABASE_TABLE = "drug_database";
    ...
    /**
     * Drug database table columns
     */
    private static final String KEY_DRUG_BRAND_NAME = "drugBrandName";
    private static final String KEY_DRUG_GENERIC_NAME = "drugGenericName";
    private static final String KEY_DRUG_PRESCRIPTION_DETAILS = "drugPrescriptionDetails";
    private static final String KEY_DRUG_CONTRAINDICATIONS = "drugContraindications";
    private static final String KEY_DRUG_PREGNANCY_CATEGORY = "drugPregnancyCategory";
    ...
    /**
     * Drug database Table: create statement
     */
    private static final String CREATE_DRUG_DATABASE_TABLE =
            "create table " + DRUG_DATABASE_TABLE + "("
                    + KEY_ROWID + " integer primary key,"
                    + KEY_DRUG_BRAND_NAME + " text not null,"
                    + KEY_DRUG_GENERIC_NAME + " text,"
                    + KEY_DRUG_PRESCRIPTION_DETAILS + " text,"
                    + KEY_DRUG_CONTRAINDICATIONS + " text,"
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL(CREATE_DRUG_DATABASE_TABLE);
    }
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        db.execSQL("DROP TABLE IF EXISTS " + DRUG_DATABASE_TABLE);
        onCreate(db);
    }
...
// ############################## create methods ###################################### //
    ...
    public long createDrugDbEntry(Drug drug) {
        SQLiteDatabase db = this.getWritableDatabase();

        ContentValues values = new ContentValues();
        values.put(KEY_DRUG_BRAND_NAME, drug.getDrugBrandName());
        values.put(KEY_DRUG_GENERIC_NAME, drug.getDrugGenericName());
        values.put(KEY_DRUG_PRESCRIPTION_DETAILS, drug.getDrugPrescriptionDetails());
        values.put(KEY_DRUG_CONTRAINDICATIONS, drug.getDrugContraindications());
        values.put(KEY_DRUG_PREGNANCY_CATEGORY, drug.getDrugPregnancyCategory());
...
// ############################# get methods ####################################### //
    ...
    public ArrayList<Drug> getDrugsByGeneric(String genericName) {
        ...
        if (c.moveToFirst()) {
            do {
                Drug drug = new Drug();
                drug.setDrugBrandName(c.getString(c.getColumnIndex(KEY_DRUG_BRAND_NAME)));
                drug.setDrugGenericName(c.getString(c.getColumnIndex(KEY_DRUG_GENERIC_NAME)));
                drug.setDrugContraindications(c.getString(c.getColumnIndex(KEY_DRUG_CONTRAINDICATIONS)));
                drug.setDrugDosage(c.getString(c.getColumnIndex(KEY_DRUG_DOSAGE)));
...
// ############################### delete methods##################################### //
    ...
    public void truncateDrugsTable() {
        SQLiteDatabase db = this.getWritableDatabase();
        db.execSQL("delete from "+ DRUG_DATABASE_TABLE);
    }
}